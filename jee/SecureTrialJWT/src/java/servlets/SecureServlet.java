...
SecureClient cl;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
             out.println("<a href='logout.jsp'>Logout</a> " + request.getContextPath() + "</h1>");
...
//             
             cl = new SecureClient();
         try{    
            out.println("<h1>Servlet Says: " + sb.saySecureHello()+ " </h1>");
            out.println("<h1>Rest Call: " + cl.sayHello()+ " </h1>");
         }
         catch(Exception e)
         {
