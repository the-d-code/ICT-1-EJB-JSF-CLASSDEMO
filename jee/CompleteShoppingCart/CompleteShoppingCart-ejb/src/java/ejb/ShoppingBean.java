 ...
 * @author root
 */
@Stateful(mappedName = "ejb/MyCart1")
    ...
    public void addToCart(String[] names, String[] prices, String[] quantities) {
        ...
        if (contents.isEmpty()) {
            ...
            for (int k = 0; k < names.length; k++) {
                ...
                h.put("total", new Double(Double.parseDouble(prices[k]) * Integer.parseInt(quantities[k])));
                contents.add(h);
            ...
            for (int num = 0; num < names.length; num++) {
                if (!names[num].equals("present")) {
                    ...
                    h.put("total", new Double(Double.parseDouble(prices[num]) * Integer.parseInt(quantities[num])));
                    contents.add(h);
                }
